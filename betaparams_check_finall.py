...
# Load the dataset
file_path = r"D:\2026\SYNTC\SYNTC-main\data\PAR_1977_2023.csv"
...
plt.tight_layout()
plt.savefig(r"D:\2026\SYNTC\SYNTC-main\data\plots\wind_speed_beta_fits_1977_203.png")  # Save the figure
plt.show()
